...
# 1. 모델 불러오기
from tensorflow.keras.models import load_model
model = load_model('test_sesame_class_01.h5')
...
test_generator = test_image.flow_from_directory(
        'C:/Users/USER/Desktop/HotSix/deeplearning/testimg4',
        target_size=(30, 30),
        class_mode='categorical')
...
print(a, b)
filename = 'testimg_se.jpg'
class_name = ["마름병", "참깨 역병", "흰가루병"]
image = cv2.imread('C:/Users/USER/Desktop/HotSix/deeplearning/testimg4/img/' + filename)
