...
# 1. 모델 불러오기
from tensorflow.keras.models import load_model
model = load_model('test_pepper_class_01.h5')
...
test_generator = test_image.flow_from_directory(
        'C:/Users/USER/Desktop/HotSix/deeplearning/testimg2',
        target_size=(30, 30),
        class_mode='categorical')
...
print(a, b)
filename = 'testimg_pa.jpg'
class_name = ["탄저병", "칼슘부족", "고추 역병"]
image = cv2.imread('C:/Users/USER/Desktop/HotSix/deeplearning/testimg2/img/' + filename)
